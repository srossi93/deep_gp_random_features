...
if __name__ == '__main__':
    ...
    old = scale(np.genfromtxt('../../generic-unsupervised-fraud-detection/resource/data/old_faithful.csv', delimiter=','))
    data = DataSet(old, old)
    test = DataSet(old, old)
